                ...
                <form onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <div className="grid grid-cols-3 md:grid-cols-4 gap-2">
                        ...
                        <label className="form-control w-full">
                            ...
                            <select defaultValue={property.livingRoom} {...register('livingRoom', { required: true })}
                                className="select select-bordered w-full">
                                <option disabled value={property.livingRoom}>{property.livingRoom}</option>
                        ...
                        <label className="form-control w-full">
                            ...
                            <select defaultValue={property.diningRoom} {...register('diningRoom', { required: true })}
                                className="select select-bordered w-full">
                                <option disabled value={property.diningRoom}>{property.diningRoom}</option>
                                <option value="yes">Yes</option>
                                <option value="no">No</option>
                            </select>
                        </label>
                        ...
                        <label className="form-control w-full">
                            ...
                            <input
                                ...
                                defaultValue={property.builtYear}
                        ...
                        <label className="form-control w-full">
                            ...
                            <select defaultValue={property.type} {...register('type', { required: true })}
                                className="select select-bordered w-full">
                    ...
                    <div className="flex gap-4">
                        ...
                        <label className="form-control w-full my-4">
                            ...
                            <select defaultValue={property.district} {...register('district', { required: true })}
                                className="select select-bordered w-full">
                                <option disabled value={property.district}>{property.district}</option>
                    ...
                    {/* property Image */}
                    <img src={property.image} alt="property Image" className="h-24 w-24 mt-2" />
                    ...
                    <button className="btn">Update Property <FaHome></FaHome></button>
                </form>
            </div>
        </div>
    );
